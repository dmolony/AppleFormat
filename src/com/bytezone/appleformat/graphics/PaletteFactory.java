...
// -----------------------------------------------------------------------------------//
{
  ...
  {
    palettes.add ( //
        new Palette ("Virtual II", new int[] {  //
            0x000000, // 0 black
            0xDD0033, // 1 magenta
            0x885500, // 2 brown         (8)
            0xFF6600, // 3 orange        (9)
    ...
    palettes.add ( //
        new Palette ("Applewin (old)", new int[] {//
            rgb (0, 0, 0),        // 0 black    
            rgb (208, 0, 48),     // 1 red      
            rgb (128, 80, 0),     // 2 brown    
            rgb (255, 128, 0),    // 3 orange   
            rgb (0, 128, 0),      // 4 dk green 
            rgb (128, 128, 128),  // 5 gray     
            rgb (0, 255, 0),      // 6 lt green 
            rgb (255, 255, 0),    // 7 yellow   
            rgb (0, 0, 128),      // 8 dk blue  
            rgb (255, 0, 255),    // 9 purple   
            rgb (192, 192, 192),  // A grey     
            rgb (255, 144, 128),  // B pink     
            rgb (0, 0, 255),      // C med blue 
            rgb (96, 160, 255),   // D lt blue  
            rgb (64, 255, 144),   // E aqua     
            rgb (255, 255, 255)   // F white
        }));

    palettes.add //
    (new Palette ("Applewin (new)", new int[] {//
        0x000000, // 0 black    
        0x9D0966, // 1 red    
        0x555500, // 2 brown    
        0xF25E00, // 3 orange     
    ...
    palettes.add (//
        new Palette ("NTSC corrected", new int[] {//
            0x000000, // black
            0x901740, // magenta
            0x405400, // brown
            0xD06A1A, // orange
    ...
    palettes.add (//
        new Palette ("Monochrome", new int[] { //
            rgb (0, 0, 0),        // 0 black 
            rgb (0, 0, 0),        // 1 black 
            rgb (0, 0, 0),        // 2 black 
            rgb (0, 0, 0),        // 3 black 
